...
namespace nts {
    ...
    void C4013::simulate(std::size_t tick)
    {
        ...
        if (set1 == True)
            ...
            _q1_next = False;
        else if (_lastClock1 != True && clock1 == True)
        ...
        if (set2 == True)
            ...
            _q2_next = False;
        else if (_lastClock2 != True && clock2 == True)
    ...
    Tristate C4013::compute(std::size_t pin)
    {
        ...
        switch (pin) {
            case 1:  return _q1;
            case 2:  return TristateLogic::notGate(_q1);
            case 13: return _q2;
            case 12: return TristateLogic::notGate(_q2);
